...
var n$1 = "function" === typeof Symbol && Symbol.for,
    ...
    u$2 = n$1 ? Symbol.for("react.profiler") : 60114,
    v$2 = n$1 ? Symbol.for("react.provider") : 60109,
...
F$2.prototype.setState = function (a, b) {
  if ("object" !== typeof a && "function" !== typeof a && null != a) throw Error(C$2(85));
  this.updater.enqueueSetState(this, a, b, "setState");
};
...
I$2.constructor = H$2;
objectAssign$1(I$2, F$2.prototype);
...
function M$2(a, b, c) {
  var e,
      ...
      g = null,
      k = null;
  if (null != b) for (e in void 0 !== b.ref && (k = b.ref), void 0 !== b.key && (g = "" + b.key), b) K$2.call(b, e) && !L$2.hasOwnProperty(e) && (d[e] = b[e]);
  var f = arguments.length - 2;
  if (1 === f) d.children = c;else if (1 < f) {
    for (var h = Array(f), m = 0; m < f; m++) h[m] = arguments[m + 2];
...
function T$2(a, b, c, e) {
  ...
  if (Array.isArray(a)) for (var k = 0; k < a.length; k++) {
    ...
    var f = b + U$2(d, k);
    g += T$2(d, f, c, e);
  } else if (null === a || "object" !== typeof a ? f = null : (f = B$1 && a[B$1] || a["@@iterator"], f = "function" === typeof f ? f : null), "function" === typeof f) for (a = f.call(a), k = 0; !(d = a.next()).done;) d = d.value, f = b + U$2(d, k++), g += T$2(d, f, c, e);else if ("object" === d) throw c = "" + a, Error(C$2(31, "[object Object]" === c ? "object with keys {" + Object.keys(a).join(", ") + "}" : c, ""));
  return g;
}
...
function aa$1(a, b, c) {
  ...
  Array.isArray(a) ? X$2(a, e, c, function (a) {
    return a;
  }) : null != a && (O$2(a) && (a = N$2(a, d + (!a.key || b && b.key === a.key ? "" : ("" + a.key).replace(P$2, "$&/") + "/") + c)), e.push(a));
}

function X$2(a, b, c, e, d) {
  var g = "";
  null != c && (g = ("" + c).replace(P$2, "$&/") + "/");
  b = R$2(b, g, e, d);
  V$2(a, aa$1, b);
  S$2(b);
}
...
var Fragment$1 = r$1;
var Profiler$1 = u$2;
var PureComponent$1 = H$2;
var StrictMode$1 = t$1;
var Suspense$1 = y$1;
var __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED$2 = ba$2;

var cloneElement$1 = function (a, b, c) {
  ...
  if (null != b) {
    ...
    for (h in b) K$2.call(b, h) && !L$2.hasOwnProperty(h) && (e[h] = void 0 === b[h] && void 0 !== f ? f[h] : b[h]);
  }
...
var createContext$1 = function (a, b) {
  void 0 === b && (b = null);
  a = {
    $$typeof: w$1,
    _calculateChangedBits: b,
...
var createElement$1 = M$2;

var createFactory$1 = function (a) {
...
var isValidElement$1 = O$2;

var lazy$1 = function (a) {
  return {
    $$typeof: A$1,
    _ctor: a,
    _status: -1,
...
var react_production_min$1 = {
  ...
  Suspense: Suspense$1,
  __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED$2,
...
var Template = function Template() {
  ...
  }, /*#__PURE__*/react.createElement(bundle, null), /*#__PURE__*/react.createElement("div", {
    align: "center"
  }, "Hello from Template!"));
};

reactDom.render( /*#__PURE__*/react.createElement(Template, null), document.getElementById("app"));
